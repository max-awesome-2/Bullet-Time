...
///// explosion effect that shakes the camera slightly
// the maximum shake distance of the camera
float cameraShakeMaxIntensity = 0.35;

// the time that the last explosion occurred -  used to determine how much the camera should be shaking on any given frame
float lastExplosionTime = -100;

// the amount of time that the camera shakes for after an explosion
